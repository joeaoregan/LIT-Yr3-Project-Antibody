...
void HighScores::handleMenuEvents(SDL_Event& e) {
	// Handle button events
	gReturnToMenu.handleEvent(&e, 0);
}

void HighScores::closeMenuMedia() {
	// Buttons
...
void HighScores::draw() {
	...
	Texture::Instance()->renderMap("shipOutlineID", 0, 50, SCREEN_WIDTH, 620);		// Draw ship outline image to screen
