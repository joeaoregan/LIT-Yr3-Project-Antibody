...
| **C** | **V** | Hold to activate the rocket and power bar; release to fire. Note: If not released before the bar finishes, the rocket will  |
...
![Game Controller 1](images/game_controller1.png)

![Game Controller 2](images/game_controller2.png)
